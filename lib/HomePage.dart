    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: ElevatedButton(
              style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all(Color(0xFFEFEEEE))),
              onPressed: () {
                setState(() {});
              },
              child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                Padding(
                  ...
                  child: Container(
                      width: 24, height: 24, child: Icon(Icons.search)),
                ),
                Padding(
                            ...
                            Text.rich(TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                      text: '10% off',
                                      style:
                                          TextStyle(color: Color(0xFFFA4A0C))),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Foods',
                        style:
                            TextStyle(fontSize: 18, color: Color(0xFFFA4A0C)),
                      ),
                      Text('Drinks',
                          style: TextStyle(
                              fontSize: 18, color: Color(0xFF9A9A9D))),
                      Text('Snacks',
                          style: TextStyle(
                              fontSize: 18, color: Color(0xFF9A9A9D))),
                      Text('Sauce',
